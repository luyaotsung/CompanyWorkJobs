...
array=(HT42JWM00259 HT3CKWM00021 HT3CLWM00090)
#with moto x
#array=(TA64300Y6A HT3B8WM00015 HT3CLWM00090)

   

$ADB -s ${array[2]} shell getevent > event-DepthMaker.log &
...
PressBack()
{
    ...
    do
        ...
        then
            ...
            sleep 0.5
            $ADB -s ${array[$i]} shell input swipe 1500 539 600 539
            sleep 0.5
            $ADB -s ${array[$i]} shell input tap 788 976
            sleep 0.5
            $ADB -s ${array[$i]} shell input tap 870 1000
            sleep 0.5
        elif [ "$i" == 1 ] 
        then   
            $ADB -s ${array[$i]} shell input keyevent 4 &
            ...
            $ADB -s ${array[$i]} shell input swipe 1500 539 600 539
            sleep 0.5
            $ADB -s ${array[$i]} shell input tap 1000 538
            sleep 0.5
            $ADB -s ${array[$i]} shell input tap 1714 956
            sleep 0.5
            $ADB -s ${array[$i]} shell input tap 145 931
            sleep 0.5
        else
            $ADB -s ${array[$i]} shell input keyevent 4 &
        fi
